...
# iterate through daily_transactions, and for each transaction, split the string around  + character used in earlier step to replace the ;,; artifacts with.

# Append each of these split strings (which are listed now) to new list daily_transactions_split
